...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><h2>REGISTRO DE PERSONAS</h2></a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Ingrese sus Datos</p>

    <?php echo "<form action='savePersona.php?rol=$rol & llamado=$llamado' method='post'>";?>  
     ...
     <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        ...
        <div class='box-footer'>
            <?php echo "<a href='readPersona.php?rol=$rol'><button type='button' class='btn btn-default'>CANCELAR</button></a>";?>
            <?php echo "<a href='savePersona.php?rol=$rol'><button type='submit' class='btn btn-info pull-right'>REGISTRAR</button></a>";?>
        </div>
